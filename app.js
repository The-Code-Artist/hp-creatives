...
app.post("/contact", (req, res) => {
  ...
  request(verifyUrl, (error, response, body) => {
	...
	<title>HP Creatives Contact Email</title>
	<style type="text/css">
		* {
...
<center class="wrapper" style="width:100%;table-layout:fixed;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;background-color:#ececec;">
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                  ...
                                  <tbody>
                                    <tr>
                                      <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0">
                                          ...
                                          <tr>
                                            <td height="6" bgcolor="#582e6a" class="contents" style="width:100%; border-top-left-radius:10px; border-top-right-radius:10px"></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                  </tbody>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#5b5f65; font-size:28px; text-align:left; font-family: Verdana, Geneva, sans-serif">Hi HP Creatives, </p>
  ...
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" border="0"  bgcolor="#582e6a">
      <tr>
        <td height="40" align="center" bgcolor="#582e6a" class="one-column">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" bgcolor="#582e6a" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:#ffffff; font-family: Verdana, Geneva, sans-serif; text-align:center">HP Creatives (Pty) Ltd</font></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#582e6a" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" bgcolor="#582e6a" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table width="150" border="0" cellspacing="0" cellpadding="0">
          <tr>
			<td width="33" align="center">
				<a href="https://www.facebook.com/hpcreativess/" target="_blank">
					<i class="fa fa-facebook"></i>
				</a>
		</td>
            <td width="33" align="center">
				<a href="https://www.instagram.com/hp_creatives/" target="_blank">
      ...
      <tr>
        <td height="6" bgcolor="#582e6a" class="contents1" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
      </tr>
      </table></td>
  </tr>
  <tr>
    <td><table width="100%" cellpadding="0" cellspacing="0" border="0"> 
      <tr>
        <td height="6" bgcolor="#582e6a" class="contents" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
    ...
    sendEmail(email, `HPC Contact Form - ${enquiry}`, messageBody, (err, data) => {
      if (err) {
        res.status(500).json({ msg: "An internal error occurred." });
      } else {
        return res.json({
          msg: "Your message has successfully been sent to HP Creatives (Pty) Ltd."
        });
      }
    });    
  });
